...
function DetalleProductos(props) {
  ...
  useEffect(() => {
    ...
    const productosApi = async () => {
      ...
      const url = `/admin/productosApi/${props.match.params.id}`; //aqui no sale
          ...
          >
            ...
            <tbody>
              <tr>
                ...
                <td>
                  {" "}
                  {/* <img src={`http://192.168.1.37:3000${productos.img_destination}`} /> */}
                  <img src={`${productos.img_destination}`} />
                </td>
